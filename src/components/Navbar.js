...
// as we mentioned here that title must be string and if we not gie title string then console will give an error 
Navbar.propTypes = {
  title: PropTypes.string.isRequired,
  aboutText: PropTypes.string.isRequired
};

// if i not pass props to the <Navbar /> in app then use this as default 
Navbar.defaultProps ={
  title:"lokesh",
  aboutText: "kumar"
}
